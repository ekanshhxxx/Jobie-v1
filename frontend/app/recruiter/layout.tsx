...
export default function RecruiterLayout({
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#0b0f1a] text-gray-900 dark:text-gray-100 font-sans antialiased flex h-screen overflow-hidden selection:bg-violet-200 dark:selection:bg-violet-900 selection:text-violet-900 dark:selection:text-violet-100 relative z-0 transition-colors duration-300">

...
import { evaluate, evaluateText, evaluateTextForUser, getAtsHistory, getLatestJobAtsCheck } from '../controllers/atsController';
...
router.get('/latest/:jobId/:userId', verifyToken, getLatestJobAtsCheck);
